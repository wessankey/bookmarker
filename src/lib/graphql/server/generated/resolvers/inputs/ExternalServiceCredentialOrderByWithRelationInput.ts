...
@TypeGraphQL.InputType("ExternalServiceCredentialOrderByWithRelationInput", {
  isAbstract: true
})
export class ExternalServiceCredentialOrderByWithRelationInput {
  ...
  externalService?: ExternalServiceOrderByWithRelationInput | undefined;
