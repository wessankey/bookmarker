...
@TypeGraphQL.InputType("ExternalServiceUpdateWithoutExternalServiceCredentialInput", {
  isAbstract: true
})
export class ExternalServiceUpdateWithoutExternalServiceCredentialInput {
