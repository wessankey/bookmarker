...
export class AccountCrudResolver {
  ...
  async findFirstAccountOrThrow(@TypeGraphQL.Ctx() ctx: any, @TypeGraphQL.Info() info: GraphQLResolveInfo, @TypeGraphQL.Args() args: FindFirstAccountOrThrowArgs): Promise<Account | null> {
    const { _count } = transformInfoIntoPrismaArgs(info);
  ...
  async getAccount(@TypeGraphQL.Ctx() ctx: any, @TypeGraphQL.Info() info: GraphQLResolveInfo, @TypeGraphQL.Args() args: FindUniqueAccountOrThrowArgs): Promise<Account | null> {
    const { _count } = transformInfoIntoPrismaArgs(info);
