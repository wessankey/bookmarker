...
const modelsInfo = {
  ...
  Tag: ["id", "value", "userId", "tagColor", "bookmarkId"],
...
const outputsInfo = {
  ...
  TagGroupBy: ["id", "value", "userId", "tagColor", "bookmarkId", "_count", "_min", "_max"],
  ...
  TagCountAggregate: ["id", "value", "userId", "tagColor", "bookmarkId", "_all"],
  TagMinAggregate: ["id", "value", "userId", "tagColor", "bookmarkId"],
  TagMaxAggregate: ["id", "value", "userId", "tagColor", "bookmarkId"],
...
const inputsInfo = {
  ...
  TagWhereInput: ["AND", "OR", "NOT", "id", "value", "userId", "tagColor", "User", "Bookmark", "bookmarkId"],
  TagOrderByWithRelationInput: ["id", "value", "userId", "tagColor", "User", "Bookmark", "bookmarkId"],
  TagWhereUniqueInput: ["id", "value"],
  TagOrderByWithAggregationInput: ["id", "value", "userId", "tagColor", "bookmarkId", "_count", "_max", "_min"],
  TagScalarWhereWithAggregatesInput: ["AND", "OR", "NOT", "id", "value", "userId", "tagColor", "bookmarkId"],
  ...
  TagCreateInput: ["id", "value", "tagColor", "User", "Bookmark"],
  TagUpdateInput: ["id", "value", "tagColor", "User", "Bookmark"],
  TagCreateManyInput: ["id", "value", "userId", "tagColor", "bookmarkId"],
  ...
  TagCountOrderByAggregateInput: ["id", "value", "userId", "tagColor", "bookmarkId"],
  TagMaxOrderByAggregateInput: ["id", "value", "userId", "tagColor", "bookmarkId"],
  TagMinOrderByAggregateInput: ["id", "value", "userId", "tagColor", "bookmarkId"],
  ...
  TagCreateNestedManyWithoutBookmarkInput: ["create", "connectOrCreate", "createMany", "connect"],
  ...
  TagUpdateManyWithoutBookmarkNestedInput: ["create", "connectOrCreate", "upsert", "createMany", "set", "disconnect", "delete", "connect", "update", "updateMany", "deleteMany"],
  ...
  BookmarkCreateNestedOneWithoutTagsInput: ["create", "connectOrCreate", "connect"],
  UserUpdateOneRequiredWithoutTagsNestedInput: ["create", "connectOrCreate", "upsert", "connect", "update"],
  BookmarkUpdateOneWithoutTagsNestedInput: ["create", "connectOrCreate", "upsert", "disconnect", "delete", "connect", "update"],
  ...
  TagCreateWithoutUserInput: ["id", "value", "tagColor", "Bookmark"],
  ...
  TagScalarWhereInput: ["AND", "OR", "NOT", "id", "value", "userId", "tagColor", "bookmarkId"],
  ...
  TagCreateWithoutBookmarkInput: ["id", "value", "tagColor", "User"],
  TagCreateOrConnectWithoutBookmarkInput: ["where", "create"],
  TagCreateManyBookmarkInputEnvelope: ["data", "skipDuplicates"],
  ...
  TagUpsertWithWhereUniqueWithoutBookmarkInput: ["where", "update", "create"],
  TagUpdateWithWhereUniqueWithoutBookmarkInput: ["where", "data"],
  TagUpdateManyWithWhereWithoutBookmarkInput: ["where", "data"],
  ...
  BookmarkUpsertWithoutTagsInput: ["update", "create"],
  ...
  TagCreateManyUserInput: ["id", "value", "tagColor", "bookmarkId"],
  ...
  TagUpdateWithoutUserInput: ["id", "value", "tagColor", "Bookmark"],
  ...
  TagCreateManyBookmarkInput: ["id", "value", "userId", "tagColor"],
  TagUpdateWithoutBookmarkInput: ["id", "value", "tagColor", "User"],
